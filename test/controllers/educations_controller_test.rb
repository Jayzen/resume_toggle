...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { degree: @education.degree, honor: @education.honor, major: @education.major, ranking: @education.ranking, school: @education.school } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { degree: @education.degree, honor: @education.honor, major: @education.major, ranking: @education.ranking, school: @education.school } }
